...
public class FXMLDocumentController implements Initializable {
    ...
    private void openUMLFile(ActionEvent event) {
       ...
       {
        if(!userDirectory.canRead()) userDirectory = new File("c:/Users/"+System.getProperty("user.name")+"/Documents");
    ...
    private void loadPath()
    {
        ...
        try {
            ...
            reader.close();
        } catch (IOException ex) {ta_Output.appendText("Could not load the old path");}
    }
